...
import re
VERSIONFILE="sparqlCLI/VERSION.py"
...
setup(
    ...
    description='A SPARQL command line interface',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/lambdamusic/sparql-cli',
    ...
    keywords='sparql rdf owl ontology semantic web linked data',
    ...
    entry_points={
        'console_scripts': [
            'sparql-cli=sparqlCLI.main:main',
        ],
    },
)
